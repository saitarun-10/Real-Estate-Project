...
# recommend.py
    ...
    # Your existing code for the recommendation page
st.title("Price Predictor")
...
if st.button('Predict'):
    # form a dataframe
    data = [[property_type, sector, bedrooms, bathrooms, balcony, property_age, built_up_area, servant_room, store_room, furnishing_type,
